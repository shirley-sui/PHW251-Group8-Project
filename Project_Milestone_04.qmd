...
-   Show your work by "echoing" code used in Rmd/Qmd file to create your tables and graphs. \`\`\`{r, echo = TRUE} in code chunk preferences. Use headers and sub headers to create an organized document \## Running Code
