...
#Select desired 5+ data elements from each dataframe selected_columns_sim_flu_LACounty_raw \<- sim_flu_LACounty_raw\[, c("dx_new", "severe_new", "susceptible")\]
...
combined_dataframe \<- list(selected_columns_sim_flu_LACounty_raw, selected_columns_vax_rates_quarter_raw, selected_columns_sim_flu_CA_new)
...
print("Mean:") print(mean_values)

print("Median:") print(median_values)

print("Range:") print(range_values)
