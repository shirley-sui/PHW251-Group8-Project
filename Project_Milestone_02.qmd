...
Our goal is to determine if, in California: 
1.  COVID vaccination rates reflect flu vaccination rates in the population 
2.  There is a correlation between COVID vaccination and flu rates and/or severity
...
County (sim_flu_LACounty.csv data will need to be joined into the sim_flu_CA.csv dataset)
