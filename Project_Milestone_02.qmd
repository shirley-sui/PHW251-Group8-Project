...
For ca_vax_rates, - demographic_value should be a factor - dt_admin should be a date - quarter should be a factor?

For the sim_flu data (both CA and LA County), - age_category should be a factor - race_eth should be a factor - dt_dx should be a date
...
num_sim_flu_LACounty_raw <- sim_flu_LACounty_raw[, c("dx_new", "severe_new", "susceptible")]
...
num_sim_flu_CA_new <- sim_flu_CA_new[, c("pop", "dx_new", "severe_new", "susceptible")]
...
# Print unique values from eachh of the selected columns
