...
#Project Milestone #3: Clean each dataset and include descriptive statistics for relevant data elements
...
#Loaded dataset from project milestone #2 in Milestone_2_Clean_Data
```
